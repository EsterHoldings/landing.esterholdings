<script setup lang="ts">
  ...
  const title = computed(() => resolveText("cabinet.dashboard.summary.pendingTransactions", "Pending transactions"));
</script>
  ...
  <PanelDefault class="relative h-full min-h-[72px] p-2.5 sm:min-h-[88px] sm:p-3.5">
    <div class="summary-widget">
      ...
      <template v-else>
        ...
        <UiTextH3 class="summary-value amount-text !text-[var(--color-warning)]">
          {{ props.total }}
        </UiTextH3>
      </template>
    </div>
