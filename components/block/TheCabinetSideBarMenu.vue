<template>
  <ul
      class="w-full p-3
           flex flex-row items-start justify-evenly gap-0
...
const menuItems = computed(() => [
  ...
  {title: t('cabinet.menu.payment_details'), to: addCurrentLocaleToPath('payments/details'), icon: UiIconPaymentDetail},
...
const secondMenuItems = computed(() => [
  {title: t('cabinet.menu.support'), to: addCurrentLocaleToPath('support'), icon: UiIconSupport, notificationsCount: 3},
