          ...
          >
            <h1 class="hero__title">
              <span
                  ...
                  :data-text="activeSlide.line1Prefix"
              >
                {{ activeSlide.line1Prefix }}
              </span>
              <span
                  class="hero__shimmer hero__shimmer--accent"
                  :data-text="activeSlide.line1Accent"
              >
                {{ activeSlide.line1Accent }}
              </span>
              <span
                  class="hero__shimmer hero__shimmer--title"
                  :data-text="activeSlide.line1Suffix"
              >
              ...
              <template v-if="activeSlide.line2Prefix || activeSlide.line2Accent || activeSlide.line2Suffix">
                ...
                <span
                    class="hero__shimmer hero__shimmer--title"
                    :data-text="activeSlide.line2Prefix"
                >
                  {{ activeSlide.line2Prefix }}
                </span>
                <span
                    class="hero__shimmer hero__shimmer--accent"
                    :data-text="activeSlide.line2Accent"
                >
                  {{ activeSlide.line2Accent }}
                </span>
                <span
                    class="hero__shimmer hero__shimmer--title"
                    :data-text="activeSlide.line2Suffix"
                >
            ...
            <p
                ...
                :data-text="activeSlide.subtitle"
            >
