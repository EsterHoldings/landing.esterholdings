...
<template>
  <UiContainer>
    <div class="pb-10 referrals">
      <div class="flex justify-between mb-10 referrals__tabs">
...
const tabsList = computed(() => [
  { label: t("cabinet.referrals.index.tabs.general"), component: TabGeneral },
  { label: t("cabinet.referrals.index.tabs.settings"), component: TabSettings },
  { label: t("cabinet.referrals.index.tabs.terms"), component: TabTerms },
]);
