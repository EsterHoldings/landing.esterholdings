...
import ClientsPanelSearch from "~/pages/clients/components/ClientsPanelSearch.vue";
...
import {
  ...
  clientsData,
} from "~/pages/clients/composables";

import {
  handleInputSearch,
  handleChangePage, handleChangePerPage,
  loadData, handleClickDeleteIcon
} from "~/pages/clients/composables/setup";
import ClientsPanelEdit from "~/pages/clients/components/ClientsPanelEdit.vue";
import ClientsPanelAddNew from "~/pages/clients/components/ClientsPanelAddNew.vue";
