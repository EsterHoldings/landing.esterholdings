      ...
      <PanelDefault>
        ...
        <div class="user-verification__left__verification-list_wrapper">
          <ul class="user-verification__left__verification-list">
            ...
            <li>
              <UiIconSuccess /><span>{{ t("cabinet.dashboard.accountVerification.documentVerified") }}</span>
            </li>
            <li>
              <UiIconWarning /><span>{{ t("cabinet.dashboard.accountVerification.paymentInProgress") }}</span>
            </li>
            <li>
              <UiIconWarning /><span>{{ t("cabinet.dashboard.accountVerification.profileInProgress") }}</span>
            </li>
          </ul>
          <div
