<template>
  <div class="roles-panel__edit">
    ...
    >
      <div class="roles-panel__edit__content__fields">
        <UiFormControl
          :label="
            t('admin.accounts.components.accounts-panel-edit.labels.name')
          "
        ...
        >
          <UiInput
            :placeholder="
              t(
                'admin.accounts.components.accounts-panel-edit.placeholders.name'
              )
            "
            :value="formData.name"
        ...
        <UiFormControl
          :label="
            t(
              'admin.accounts.components.accounts-panel-edit.labels.permissions'
            )
          "
        ...
        >
          <UiMultiSelect
            :placeholder="
              t(
                'admin.accounts.components.accounts-panel-edit.placeholders.permissions'
              )
            "
  ...
  <div class="roles-panel__edit__bottom">
    ...
    >
      {{
        t("admin.accounts.components.accounts-panel-edit.submit")
      }}</UiButtonDefault
    >
  </div>
</template>
